...
const ProfilePage = () => {
  ...
  const handleProfilePicChange = (e) => {
    ...
    setPreviewImage(URL.createObjectURL(file)); // temporary preview URL
  };
  ...
  return (
    <div className="border w-full h-screen sm:px-[15%] sm:py-[5%] overflow-auto flex justify-center items-center">
      <div className="p-5 h-full w-full rounded-xl flex flex-col backdrop-blur-lg bg-white/10 border border-white/20">
        ...
        {/* BOTTOM 50% - Lists */}
        <div className="h-1/2 flex gap-3 mt-3">
          {/* Request List */}
          <div className="w-1/2 border border-white/20 rounded-xl p-3 overflow-auto text-white">
